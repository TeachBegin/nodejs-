...
import { TransitionMotion, StaggereMotion, spring, presets, Motion } from 'react'
  ...
  constructor(props){
    ...
    this.state = {
      todos:[
        ...
        {key: 't4', data: {text: 'Try to finish conference slides', isDone: false}},
      ...
      <div className="rightcontent">
        <section className="todoapp">
          ...
          <section className="main">
              ...
              <TransitionMotion styles={this.getStyles} willLeave={this.willLeave} willEnter={this.willEnter} value={value} onChange={this.handleChange}>
              {
                  styles => 
